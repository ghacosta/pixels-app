...
import { theme, FONT_WEIGHT_BOLD, FONT_WEIGHT_MEDIUM } from "@/constants/theme";
    ...
    <View style={styles.container}>
      ...
      <Animated.View entering={FadeInDown.duration(600)} style={{ flex: 1 }}>
        ...
        <View style={styles.contentContainer}>
          ...
          <Animated.Text entering={FadeInDown.delay(500).springify()} style={styles.subtitle}>Every Pixel Tells a Story</Animated.Text>
